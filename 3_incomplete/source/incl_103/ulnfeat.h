...
#endif
#else
#error This features test ONLY with Borland or Microsoft compilers
#endif
...
#define __RNAME(n,l,s) RESOURCE_STRING ## _ ## n ## _ ## l ## _ ## s
...
#define RESOURCE_STRING_ID(n) ((UINT)&__RSNAME(n))
